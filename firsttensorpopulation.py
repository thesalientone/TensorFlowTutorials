...
def my_input_fn(features, targets, batch_size = 1, shuffle = True, num_epochs=None):
    ...
    Returns:
        Tuple of (features, labels) for next data batchself.
...
#Note: Since we're making just one prediction for each example, we dont' need to repeat or shuffle the data her

prediction_input_fn = lambda: my_input_fn(my_feature, targets, num_epochs=1, shuffle=False)

#Call predict() on teh linear_regressor to make predictions
...
#print weight
#print bias
#Get the predicted median_house_values fro the min and max total_room values
# y_0 = weight * x_0 + bias
# y_1 = weight * x_1 + bias
#
